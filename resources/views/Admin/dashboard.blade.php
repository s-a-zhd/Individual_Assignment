					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Upcoming Appointments number</h4> <a href="/appointment" class="btn btn-primary float-right">View all</a>
							</div>
									...
									<table class="table mb-0">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-right">
													<a href="/appointment" class="btn btn-outline-primary take-btn">Take up</a>
                                                </td>
                                ...
                                <ul class="contact-list">
                                        ...
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="John Doe"><img src="/assets/images/upload_images" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis"></span>
